var app = angular.module('PhonX', ['ionic', 'ionic-material', 'ionicOAuthService', 'ngCordova', 'ngResource', 'ngRoute', 'firebase'])
...
app.config(["$routeProvider",
  function ($routeProvider) {
    $routeProvider.
      ...
      when("/main_menue", {
        templateUrl: "partials/main_menue_view.html",
        controller: "main_menue_Ctrl",
        resolve: {isAuth}
      }).
      // when("/user-main", {
